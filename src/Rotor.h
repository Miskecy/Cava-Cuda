...
// Estrutura para passar parâmetros de thread
typedef struct
{
	Rotor *obj;
	int threadId;
...
{
public:
	// Variável membro para armazenar a cor
	int color;
	/** PROGRESSO DO MODO ALEATÓRIO**/
	std::string startRandomKey; // Inicializa startRandomKey
	std::string endRandomKey;	// Inicializa endRandomKey
...
private:
	...
	// Método generateRandomKeyInRange
	Int generateRandomKeyInRange(const Int &rangeStart, const Int &rangeEnd);
